...
{
    public BANxOpen.Foundation.Contracts.Materials.MaterialLibrary Parse(MaterialLibraryId id, string displayName, string xmlContent)
    {
        ...
        return new BANxOpen.Foundation.Contracts.Materials.MaterialLibrary(id, displayName, materials);
    }
